...
'''
    ...
    result = {}
    for bloco in blocos:
        # 3.1) O rótulo (Investimento, Área, …) é *text* imediato do bloco,
        #       mas ele vem com \n e espaços extras -> use .strip().
        #       Para ignorar o texto filho <div class="fonte-500">, basta limitar na divisão.
